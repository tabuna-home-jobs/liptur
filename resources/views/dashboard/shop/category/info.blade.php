<div class="container">
    ...
    <div class="padder-md">
    <input type="hidden" name="taxonomy" value="shop-category">
    <input type="hidden"
           name="term_id"
    ...
    <div class="form-group">
        ...
        <div class="form-group m-t-md none">
        ...
        {!! generate_form($behavior->fields(), !$termTaxonomy->exists ? [] : optional($termTaxonomy->term)->toArray(), 'ru','content') !!}
