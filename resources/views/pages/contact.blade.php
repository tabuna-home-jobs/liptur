        ...
        <section class="container">
            <div class="row wrapper-md  m-t-md m-b-xs">
                <div id="helpletter" class="col-md-6 hidden-xs hidden-sm">
                    <p class="h3 font-thin m-b-md">Вам нужна помощь?</p>
                ...
                <div class="col-md-6 col-xs-12 col-sm-12">
                    ...
                    <p class="h3 font-thin m-b-md">Контакты для связи</p>
         ...
         8-800-200-81-20</a></span>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <h5 class="block-title font-bold hint-text m-b-0">Первый заместитель начальника управления
                                культуры и туризма
                                Липецкой области</h5>
