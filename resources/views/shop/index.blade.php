...
<section>
    <div class="container padder-v">
        ...
        <div id="shop" class="row">
            ...
            @if ($loop->index<4) <article class="col-sm-6 col-md-3 padder-v shop-product">
                <div class="panel panel-default box-shadow-lg pos-rlt">
                    <div data-mh="main-news-img">
                        <a href="{{route('shop.product',$product->slug)}}">
                            <img src="{{$product->hero('medium') ?? '/img/icons/slon.png' }}" class="img-full img-post">
                        </a>
                    </div>
    ...
    <div class="wrapper bg-white main-category">
        ...
        <div class="container padder-v">
            ...
            <div id="shop1" class="row">
                ...
                @if ($loop->index<8) <article class="col-sm-6 col-md-3 padder-v shop-product">
                    <div class="panel panel-default box-shadow-lg pos-rlt">
                        <div data-mh="main-news-img">
                            <a href="{{route('shop.product',$product->slug)}}">
                                <img src="{{$product->hero('medium') ?? '/img/icons/slon.png' }}" class="img-full img-post">
