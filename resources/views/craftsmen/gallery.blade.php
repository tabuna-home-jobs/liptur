@extends('layouts.craftsmen')



@section('craftsmen_main')
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="item padder-v">
                                    <div class="pos-rlt">
                                        <div class="bottom">
                                            <div class="v-center">
                                                <span class="text-white small wrapper w-md">{{$album->getContent('name')}}</span>
                        ...
                        <div class="row bg-white scroll-h">
                            ...
                            <div class="col-sm-4 bg-white m-t-xl no-padder">
                                <div class="padder">
                                    ...
                                    <p class="small text-dark text-ellipsis" v-bind:title="photos[active].description">
