...
<head>
  ...
  <meta name="keywords" content="@yield('keywords',setting('site_keywords',''))"> {!! Feed::link(route('rss'), 'atom', 'Новостная лента', App::getLocale()) !!}
...
<body itemscope itemtype="http://schema.org/WebPage">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="col-md-5">
          <div class="input-group nav-search">
            <input type="text" class="form-control form-control-grey" placeholder="Введите искомое" maxlength="100">
        ...
        <li class="col-md-2">
          <div class="navbar-locale">
            <a href="{{Localization::getLocalizedURL('ru') }}" class="green-button {{App::getLocale()=='ru'? 'raised': ''}}" hreflang="ru"
              title="Сменить язык">РФ</a>
            <a href="{{Localization::getLocalizedURL('en') }}" class="green-button {{App::getLocale()=='en'? 'raised': ''}}" hreflang="en"
      ...
      <div class="container">
        <div class="container-fluid">
          <div class="row padder-v">
            ...
            <div class="col-md-3 hidden-sm vi-col-4">
              <a class="wrapper-sm click-visually v-center" data-toggle="visually-impaired" data-target="#html" title="Сайт доступен для людей с ограниченными возможностями">
            ...
            <div class="col-md-3 col-sm-6 vi-hide">
              <p>
                ...
                <a href="https://www.youtube.com/channel/UCI4HbPUrzve2L889GRE8D-g" target="_blank" class="btn btn-icon btn-rounded btn-grey">
                  <i class="fa fa-youtube"></i>
                </a>

                <a href="https://twitter.com/lipsobtur" target="_blank" class="btn btn-icon btn-rounded btn-grey">
    ...
    <div class="modal-dialog ">
      <div class="modal-content">
        <div class="modal-header">
          <p class="h5 text-center m-b-xs font-thin m-b">
              ...
              <div class="col-md-12">
                ...
                <form v-on:submit.prevent="search()">
                  <div class="form-group form-group-default">
                    ...
                    <input type="text" autofocus required minlength="1" placeholder="Например Задонщина" class="form-control input-lg" v-model="query">
                  </div>

                  <div class="col-md-3 col-md-offset-9 text-center">
                    <button class="btn btn-danger btn-rounded" type="button" v-on:click="search()" v-if="!loading">
                      <i class="fa fa-search"></i> Найти
                    </button>
                    <button class="btn btn-danger btn-rounded" type="button" disabled="disabled" v-if="loading">Поиск...
  ...
  <noscript>
    <div>
      <img src="https://mc.yandex.ru/watch/41718074" style="position:absolute; left:-9999px;" alt="" />
    </div>
  </noscript>
  <!-- /Yandex.Metrika counter -->
  ...
  <script src="//cdnjs.cloudflare.com/ajax/libs/summernote/0.8.9/summernote.js"></script> @stack('scripts')
