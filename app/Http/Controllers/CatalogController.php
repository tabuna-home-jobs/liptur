...
class CatalogController extends Controller
{
    ...
    public function index($typeRequest, Request $request): View
    {
        ...
        $elements =   \Cache::remember('catalog-controller-index-'.App::getLocale().'-'.$typeRequest.'-'.$request->server->all()['QUERY_STRING'], \Carbon\Carbon::now()->addHour(), function () use ($typeRequest) {
