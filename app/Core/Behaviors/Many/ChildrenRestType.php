...
class ChildrenRestType extends Many
{
    /**
     * @var string
     */
    public $name = 'Детский отдых';

    /**
     * @var string
     */
    public $slug = 'childrest';
     ...
     * @var string
     */
    public $image = '/img/category/child-rest.jpg';
    ...
    public function display()
    {
        return collect([
            'name'   => 'Детский отдых',
            'icon'   => 'icon-lip-ferris-wheel',
            'svg'    => '/dist/svg/maps/ferris-wheel.svg',
            'mapUrl' => true,
            'time'   => false,
        ]);
    }
